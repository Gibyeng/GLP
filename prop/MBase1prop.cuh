...
template<typename V, typename E>
void MBase1prop<V,E>::preprocess(){
...
template<typename V, typename E>
void MBase1prop<V, E>::postprocess()
{
    this->free_gmem();
}

template<typename V, typename E>
void MBase1prop<V, E>::init_gmem(V n,E m)
{
...
template<typename V, typename E>
int MBase1prop<V, E>::binary_search(E left, E right,std::vector<V> offsets, std::vector<V> vertices, V target)
{
	E ans = 0;
...
template<typename V, typename E>
void MBase1prop<V, E>::perform_lp(V n,E m,int niter)
{
	const int VT = 7;
	const int VT_m = 1;
...
template<typename V, typename E>
void MBase1prop<V, E>::run(int niter)
{
	this->preprocess();
