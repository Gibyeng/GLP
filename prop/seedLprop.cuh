...
template<typename V, typename E>
void seedLprop<V, E>::postprocess()
{
    this->free_gmem();
}

template<class V, class E>
void seedLprop<V, E>::errorCheck(std::string message){
...
template<typename V, typename E>
void seedLprop<V, E>::init_gmem(V n,E m)
{
...
template<typename V, typename E>
int seedLprop<V, E>::binary_search(E left, E right,std::vector<V> offsets, std::vector<V> vertices, V target)
{
	E ans = 0;
...
template<typename V, typename E>
void seedLprop<V, E>::assign_seeds_for_device (std::string seedfile, int n){
	//load seeds file.
...
template<typename V, typename E>
void seedLprop<V, E>::perform_lp(V n,E m,int niter)
{
	//init flag as false
	bool flag = false;
...
//    std::string seedfile{"/home/changye/Documents/GPULP/datasets/seeds/seed_100000_3000000.txt"};
    std::string seedfile{"/home/changye/Documents/GPULP/datasets/seeds/seed_10000_1000000.txt"};
...
template<typename V, typename E>
void seedLprop<V, E>::run(int niter)
{
	this->preprocess();
