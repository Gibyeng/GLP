...
template<typename V, typename E>
void classicLprop<V,E>::preprocess(Test_result* result){
	Timer t;
...
template<typename V, typename E>
void classicLprop<V, E>::postprocess()
{
    this->free_gmem();
}

template<class V, class E>
void classicLprop<V, E>::errorCheck(std::string message){
...
template<typename V, typename E>
void classicLprop<V, E>::init_gmem(V n,E m)
{
...
template<typename V, typename E>
void classicLprop<V, E>::free_gmem()
{
...
template<typename V, typename E>
int classicLprop<V, E>::get_count()
{
    int counter;
...
template<typename V, typename E>
int classicLprop<V, E>::binary_search(E left, E right,std::vector<V> offsets, std::vector<V> vertices, V target)
{
	E ans = 0;
...
template<typename V, typename E>
double classicLprop<V, E>::perform_lp(V n,E m,int niter, Test_result* result)
{
	//init flag as false
	bool flag = false;
...
template<typename V, typename E>
Test_result* classicLprop<V, E>::run(int niter)
{
