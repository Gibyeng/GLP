...
template<typename V, typename E>
void Test2prop<V,E>::preprocess(Test_result* result){
	Timer t;
...
template<typename V, typename E>
void Test2prop<V, E>::postprocess()
{
    this->free_gmem();
}

template<class V, class E>
void Test2prop<V, E>::errorCheck(std::string message){
...
template<typename V, typename E>
void Test2prop<V, E>::init_gmem(V n,E m)
{
...
template<typename V, typename E>
int Test2prop<V, E>::binary_search(E left, E right,std::vector<V> offsets, std::vector<V> vertices, V target)
{
	E ans = 0;
...
template<typename V, typename E>
double Test2prop<V, E>::perform_lp(V n,E m,int niter, Test_result* result)
{
	//init flag as false
	bool flag = false;
...
template<typename V, typename E>
Test_result* Test2prop<V, E>::run(int niter)
{
