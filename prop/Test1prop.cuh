...
template<typename V, typename E>
void Test1prop<V,E>::preprocess(Test_result* result){
	Timer t;
	t.start();
...
template<typename V, typename E>
void Test1prop<V, E>::postprocess()
{
    this->free_gmem();
}

template<class V, class E>
void Test1prop<V, E>::errorCheck(std::string message){
...
template<typename V, typename E>
void Test1prop<V, E>::init_gmem(V n,E m)
{
...
template<typename V, typename E>
int Test1prop<V, E>::binary_search(E left, E right,std::vector<V> offsets, std::vector<V> vertices, V target)
{
	E ans = 0;
...
template<typename V, typename E>
double Test1prop<V, E>::perform_lp(V n,E m,int niter, Test_result* result)
{
	//init flag as false
	bool flag = false;
...
template<typename V, typename E>
Test_result* Test1prop<V, E>::run(int niter)
{
